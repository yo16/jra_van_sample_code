...
Begin VB.UserControl ctlVBR 
   ...
   Begin TabDlg.SSTab mstTab 
      ...
      BackColor       =   14741230
      TabCaption(0)   =   "成績"
      TabPicture(0)   =   "ctlVBR.ctx":0004
      Tab(0).ControlEnabled=   -1  'True
      Tab(0).Control(0)=   "paneTab(0)"
      Tab(0).Control(0).Enabled=   0   'False
      Tab(0).ControlCount=   1
      TabCaption(1)   =   "競走馬"
      TabPicture(1)   =   "ctlVBR.ctx":0020
...
Private WithEvents mData As clsDataBR   '' データ取得オブジェクト
...
On Error GoTo ErrorHandler
    ...
    Dim i As Long
    Set mKey = New clsKeyBR
    Set mData = New clsDataBR

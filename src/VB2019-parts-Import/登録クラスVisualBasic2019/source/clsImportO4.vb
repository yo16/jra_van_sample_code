...
Friend Class clsImportO4
	...
	Private mBuf As JV_O4_ODDS_UMATAN '' オッズ（馬単）構造体
...
ErrorHandler:
    ...
    Public Function InsertDB() As Boolean
        ...
        With mBuf
            ...
            mRS1.Fields("UmatanFlag").Value = .UmatanFlag '' 発売フラグ　馬単
            mRS1.Fields("TotalHyosuUmatan").Value = .TotalHyosuUmatan '' 馬単票数合計
        End With
...
ErrorHandler:
    ...
    Public Function UpdateDB(ByRef strMakeDate As String) As Boolean
        ...
        With mBuf
            ...
            strSql = strSql & SS & "UmatanFlag" & SE & "='" & Replace(.UmatanFlag, "'", "''") & "'," '' 発売フラグ　馬単
            strSql = strSql & SS & "TotalHyosuUmatan" & SE & "='" & Replace(.TotalHyosuUmatan, "'", "''") & "'," '' 馬単票数合計

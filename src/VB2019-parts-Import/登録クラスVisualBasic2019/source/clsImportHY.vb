...
Friend Class clsImportHY
	' @(h) clsReadHY.cls
	' @(s)
	' JVData "HY" データベース登録クラス
	'
	
	Private mBuf As JV_HY_BAMEIORIGIN '' 馬名の意味由来構造体
...
ErrorHandler:
    ...
    Public Function InsertDB() As Boolean
        ...
        With mBuf
            ...
            mRS.Fields("Origin").Value = .Origin                         '' 馬名の意味由来
        End With
...
ErrorHandler:
    ...
    Public Function UpdateDB(ByRef strMakeDate As String) As Boolean
        ...
        With mBuf
            ...
            strSql = strSql & SS & "Origin" & SE & "='" & Replace(.Origin, "'", "''") & "',"              '' 馬名の意味由来

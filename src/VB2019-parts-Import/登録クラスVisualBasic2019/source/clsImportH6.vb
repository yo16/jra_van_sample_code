...
Friend Class clsImportH6
    ' @(h) clsReadH1.cls
    ' @(s)
    ' JVData "H6" データベース登録クラス
    '

    Private mBuf As JV_H6_HYOSU_SANRENTAN '' 票数（３連単）構造体
...
ErrorHandler:
    ...
    Public Function InsertDB() As Boolean
        ...
        With mBuf
            ...
            mRS1.Fields("HatubaiFlag1").Value = .HatubaiFlag '' 発売フラグ
            For i = 0 To 17
                mRS1.Fields("HenkanUma" & i + 1).Value = .HenkanUma(i) '' 返還馬番情報(馬番01～18)
            Next i
            For i = 0 To 1
                ...
                If mBuf.HyoSanrentan(i).Kumi <> "      " Then
                    ...
                    With mBuf
                        ...
                        With .HyoSanrentan(i)
                            ...
                            mRS2.Fields("Hyo").Value = .Hyo '' 票数
                            mRS2.Fields("Ninki").Value = .Ninki '' 人気
...
ErrorHandler:
    ...
    Public Function UpdateDB(ByVal strMakeDate As String) As Boolean
        ...
        With mBuf
            ...
            strSql = strSql & SS & "HatubaiFlag1" & SE & "='" & Replace(.HatubaiFlag, "'", "''") & "'," '' 発売フラグ
            For i = 0 To 17
                strSql = strSql & SS & "HenkanUma" & i + 1 & SE & "='" & Replace(.HenkanUma(i), "'", "''") & "'," '' 返還馬番情報(馬番01～18)
            Next i
            For i = 0 To 1
